...
import com.example.denisprawira.ta.Model.BloodStock;
...
import com.example.denisprawira.ta.Model.Person;
...
import com.example.denisprawira.ta.Model.Chat.UserChat;
...
public interface RetrofitServices {
    ...
    Call<List<RequestDonor>> loadRequestDonor(@Field("idUser") String idUser,@Field("status") String status);
