...
public class UserLocationServices extends Service {
    ...
    private static final String TAG = UserLocationServices.class.getSimpleName();
    public static final String ACTION_NAME = UserLocationServices.class.getSimpleName() + ".broadcast";
...
//        handler.postDelayed(runnable, 5000);
    ...
    public class LocalBinder extends Binder {
        public UserLocationServices getService() {
            return UserLocationServices.this;
        }
    }
    ...
    public void requestLocationsUpdates() {
        ...
        startService(new Intent(getApplicationContext(), UserLocationServices.class));
        try {
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                // TODO: Consider calling
                //    ActivityCompat#requestPermissions
